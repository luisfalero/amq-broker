...
public class JmsProducerConsumer {
    ...
    public void sendProducer(String personEntity){
        ...
        jmsTemplate.convertAndSend(destinationQueue, personEntity, message -> {
            ...
            message.setStringProperty(CommonsContants.JMS_CUSTOM_HEADER_01, "This is a custom jms property v1");
            message.setBooleanProperty(CommonsContants.JMS_CUSTOM_HEADER_02, true);
            message.setDoubleProperty(CommonsContants.JMS_CUSTOM_HEADER_03, 1.0);
            return message;
        });
    }
